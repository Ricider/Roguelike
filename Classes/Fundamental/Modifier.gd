...
static func all_modifiers() -> Array:
	return [
		...
		Modifier.new("Guerilla Warfare", "Your cards that have a BioCost higher than MoneyCost deal 100% more damage, but the ones that have BioCost lower than MoneyCost have 50% less HP", 25),
		Modifier.new("State of emergency", "You gain 3 HitPoints every turn", 20),
		Modifier.new("Fanaticism", "Your buildings have 50% less HP, but Units have 100% more", 30),
